...
if __name__ == '__main__':
    ...
    checkpoint_callback = CheckpointCallback(
        ...
        save_path='resources/models/default_parameters/',
    ...
    model = MaskablePPO(
        ...
        target_kl=None,
        tensorboard_log='resources/logs/default_parameters/', 
        # to see logs, run `tensorboard --logdir resources/logs/default_parameters/`
        device='cuda'
    )
